...
public class SwaggerConfig {
    ...
    private final String API_TITLE = "Wave 5 - Bootcamp Java - Mercado Livre - NotificationAPI";
    private final String API_DESCRIPTION = "Microserviço de notificação via email feito para compor o Projeto integrador, de encerramento do Bootcamp Java do Mercado Livre";
